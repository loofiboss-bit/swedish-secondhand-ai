...
v3.0.0 Guided Selling is active. It prioritizes an immediate offline start, a four-part guided
flow, explicit user-entered pricing, progressive detail, recoverable project deletion and
privacy-safe support. The target is a copy-ready listing in at most six primary actions and a
documented five-minute test from an empty profile.
